...
const Home = () => {
  return (
    <div className="md:flex justify-center  bg-[#FBFCFD] h-auto">
      {/*1*/}

      <div className="flex-col  justify-center">
        <div className="md:h-[145px]">
          <div className="md:mt-8  py-4   ">
            <p className="md:text-[48px] text-[20px] text-[#2C384A]">
              Best Website builders in the US
            </p>
          </div>
          <div className="bg-[#E1E4E6] w-full h-[1px] my-1"></div>
          <div className="text-[#4B5665] flex text-[9px] md:text-[14px]  items-center  justify-between my-1">
          ...
          <div className="bg-[#E1E4E6] w-full h-[1px] my-2"></div>
        </div>
        {/*2*/}

        <div className="w-full  md:w-3/4 flex-col mx-1  md:my-4 md:ml-3">
          <div className=" flex justify-between text-[8px] md:text-[12px]">
            {toolsArray.map((val, index) => (
              <div
                key={index}
                className="bg-[#FFFFFF] flex justify-between w-full  py-2 px-1     rounded-md md:mr-5 items-center"
              >
                <div className="w-full ">{val.value}</div>
        ...
        {/*3*/}
        <div className="flex text-[10px] md:text-[14px] mx-1 justify-between mt-2 md:w-2/4">
          {HomeArray.map((val, index) => (
            <div key={index} className="flex items-center text-[#5C6874]">
